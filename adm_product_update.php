...
<body>
  <form name="product" action="adm_product_edit.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid__column-10">
          <div class="container__input">
            <div class="container__input-product-name">
              ...
              <input type="text" class="product-name--input" name="Product_Name" value="<?php echo $row['Product_name'] ?>">
            </div>
            ...
            <div class="container__input-product-name">
              ...
              <input type="text" class="product-name--input" name="Brand" value="<?php echo $row['Brand'] ?>">
            </div>

            <div class="container__input-product-name">
              <div class="product-name">Nhập Mô Tả :</div>
              <input type="text" class="product-name--input" name="Product_Description" value="<?php echo $row['Description'] ?>">
            </div>
    
            <div class="container__input-product-name">
              <div class="product-name">Nhập Giá Đã Giảm :</div>
              <input type="text" class="product-name--input" name="Product_Price_dropped" value="<?php echo $row['Price_dropped'] ?>">
            </div>
    
            <div class="container__input-product-name">
              <div class="product-name">Nhập Tên Giá Gốc :</div>
              <input type="text" class="product-name--input" name="Product_Price" value="<?php echo $row['Price'] ?>">
            </div>
    
            <div class="container__input-product-name">
              <div class="product-name">Nhập Ảnh Sản Phẩm :</div>
              <input type="file" class="product-name--input" name="img_logo" value="<?php echo $row['Product_name'] ?>">
            </div>
    
            <button type="submit" class="product-name--submit"> Sửa hàng  </button>
          </div>
        </div>
      </div>
