...
<?php
    ...
    if($Product_name == "" ||  $Brand == "" || $product_type == "" || $Description == "" || $Price == "" || $Price_dropped == "" || $uploadDir_img_logo == "")
    {
        ...
        $sql_insert_hangxs="INSERT INTO `product`
        (`Product_id`, `Product_name`, `Brand`, `Type`, `Description`, `Price`, `Price_dropped`, `Product_img`) 
        VALUES ( NULL,'$Product_name','$Brand','$product_type','$Description','$Price','$Price_dropped','$file__name__')";
